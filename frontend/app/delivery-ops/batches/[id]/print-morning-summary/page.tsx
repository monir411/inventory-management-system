...
import { getMorningDispatchReport } from '@/lib/api/delivery-ops';
import { PrintSummary } from '@/components/delivery-ops/print-summary';
import { LoadingBlock } from '@/components/ui/loading-block';

export default function PrintMorningSummaryPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex h-screen items-center justify-center bg-white">
        <LoadingBlock label="Preparing Morning Summary for printing..." />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="print-container print-page">
        <PrintSummary report={report} mode="morning" />
      </div>
